...
def _extract_category(raw_text: str) -> str | None:
    known_categories = ["groceries", "transport", "eating out", "rent"]
    lowered = raw_text.lower()
...
def parse_expense(payload: ParseExpenseRequest) -> ExpenseDraft:
    ...
    return ExpenseDraft(
        ...
        goal_candidates=["Emergency Fund"] if "fund" in raw_text.lower() else [],
        notes="Dummy parse result generated locally.",
    )
