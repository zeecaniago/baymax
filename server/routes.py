...
def parse_expense(payload: ParseExpenseRequest) -> ExpenseDraft:
    ...
    description, merchant, category = extract_expense_details(raw_text)
    return ExpenseDraft(
        ...
        budget_treatment="excluded" if "one-off" in extract_flags(raw_text) else "included",
...
def create_expense(payload: CreateExpenseRequest) -> dict:
    ...
    expense = {
        ...
        "flags": flags,
        "budget_treatment": (
            "excluded" if "one-off" in flags else payload.budget_treatment
        ),
